...
def show():
    ...
    **Que pouvez-vous faire ici ?**
    ...
    # Explication des différentes étapes de l'application
    ...
    # Ajout de la vidéo - Remplacez le lien par le vôtre
    video_url = "https://www.youtube.com/watch?v=dQw4w9WgXcQ"  # Remplacez par le lien de votre vidéo
    st.video(video_url)

    # Section pour télécharger la documentation PDF
    ...
    # Lien de téléchargement du PDF (remplacez le chemin par le fichier réel)
